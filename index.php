...
$q="select * from img_details";
$result=mysqli_query($con,$q);
if ($row=mysqli_fetch_assoc($result))  {
	?>
.splash {
 background:url('<?= $row["imgurl"]; ?>') no-repeat fixed center bottom;
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation" id="menu">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#"><p style="color: black;border: 50%;border: 5px solid black;padding:  10px;">KH</p></a>
        </div>
...
<div class="container abouts">
	<div class="global ">	
	  <div class="row  pt-5 ">
          ...
          <h2 style="color: white;">ABOUT <span style="color: white;"> ME</span></h2>
    	    
    	    <div class="bleck" style="width: 160px;"></div>
	         <div class="col-md-12 heading-section ftco-animate fadeInUp ftco-animated">
							<!-- <h1 class="big">About</h1> -->
							<!-- <h2 class="mb-4">About Me</h2> -->
							<div class="d-md-none about-img row" style="justify-content: center;">
							    <div class="about-img-small" style="background: url('images/profile picture.jpg');background-size: cover;border: 5px white solid;box-shadow: 0 0 20px #797676;"></div>
							</div><br>
							<ul class="about-info mt-4 px-md-0">
								<li class="d-flex" style="font-size: 1.7em;"><span>Name:</span> <span>KARTIKEYA HASRH</span></li><br>
								<li class="d-flex" style="font-size: 1.7em;"><span>Date of birth:</span> <span>JULY 11, 1999</span></li><br>
								<li class="d-flex"style="font-size: 1.7em;"><span>Address:</span> <span>RAM NAGAR, Agra, Uttar Pradesh, India</span></li><br>
								<li class="d-flex"style="font-size: 1.7em;"><span>Zip code:</span> <span>282010</span></li><br>
								<li class="d-flex"style="font-size: 1.5em;"><span>Email:</span> <span><a href="mailto:kharsh11799@gmail.com">kharsh11799@gmail.com</a></span></li><br>
								<li class="d-flex"style="font-size: 1.7em;"><span>Phone: </span> <span>+919870748752</span></li>
							</ul><br>
							<p ><a href="https://drive.google.com/file/d/1qcUUtXnGHDE69cUMYWvJyTnCEEwdPkKZ/view?usp=sharing" class="btn btn-primary py-3 px-3" style="border: 2px solid white; color: white;">View Resume</a></p>
						</div>
  ...
  <div id="carousel-id" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="carousel-item active">
        <img src="img/kartikbg-12 (3).jpg" alt="First slide" class="img-fluid" width="90%">
      </div>
...
<!-- /.container -->
                ...
                <div class="col-lg-8 col-lg-offset-2 text-center contact-button">
                    <a href="#contact" class="btn btn-lg btn-outline" style="border: 10px solid white">
			...
			<div class="row">
				...
				<div class="col-md-6 col-xs-12 col-sm-6 portfolio-card-holder">
					<div class=" portfolio-card">
						<img src="img/web.png" alt="Portfolio" class="img-responsive portfolio-img">
				...
				<div class="col-md-6 col-xs-12 col-sm-6 portfolio-card-holder">
					<div class=" portfolio-card">
						<img src="img/app.png" alt="Portfolio" class="img-responsive portfolio-img">
	...
	<div class="container-fluid contact-me-container content-section" id="contact">
      ...
      <hr class="star-light">
			...
			<!-- 	<input type="text" name="name">
				...
				<input type="submit" name="value" value="SEND" class="btn btn-default submit-button btn-lg btn-primary">
			</div>
		</div>
	</div></form>
<!-- Footer -->
